                ...
                Utils.ajaxData({
                    ...
                    callback: (result) => {
                        ...
                        if (housIntermediaryInformation) {
                            this.refs.DataListing.setFieldsValue(housIntermediaryInformation);
                        }
                        if (housIntermediaryInformation) {
                ...
                Utils.ajaxData({
                    ...
                    callback: (result) => {
                        ...
                        if (housControlInformation) {
                            housControlInformation.followEnterprisesCategory = String(housControlInformation.planningPurposes);
                        } else {
                            ...
                            <div className="navLine-wrap" onScroll={NavLineUtils._handleSpy.bind(this, this.navLineData1) }>
                                <div className="col-22 navLine-wrap-left" >
                                    <div id="b1">
                                        ...
                                        <UploadPhoto style={{ marginLeft: 25 }} title="房本照片" btype="HOUSE" canEdit={false} selectRecord={props.record}/>
                                    </div>
                                    <div id="b2">
                                        <h2>基本信息</h2>
                            ...
                            <div className="navLine-wrap" onScroll={NavLineUtils._handleSpy.bind(this, this.navLineData3) }>
                                <div className="col-22 navLine-wrap-left" >
                                    ...
                                    <div id="a4" style={{ marginTop: "10px" }}>
                                        <h2>风控信息</h2>
                                        <RiskControl ref="RiskControl" canEdit={false} />
