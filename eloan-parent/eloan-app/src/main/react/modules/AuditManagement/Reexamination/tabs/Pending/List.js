...
export default React.createClass({
  ...
  fetch(params = {}) {
    ...
    Utils.ajaxData({
      url: '  /modules/workflow/ProcessTaskController/queryAuditTasks.htm?isCompleted=false&&type=usertask-recheck',
      data: params,
      callback: (result) => {
    ...
    return (
      <div className="block-panel">
        <div className="actionBtns" style={{ marginBottom: 16 }}>
          <button className="ant-btn"  disabled={!hasSelected} onClick={this.showModal.bind(this, '复审', true) }>
            复审
          </button>
        </div>
