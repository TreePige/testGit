                ...
                callback: (result) => {
                   ...
                   // if(!housBillBasicInfo.hasOwnProperty("singleRate"))
                    ...
                    this.setState({
                        ...
                        lend && refs.DocumentsFillLend.setFieldsValue(lend[0]);//取集合当中第一个元素
        ...
        return (
            <div className="block-panel">
                <div className="actionBtns" style={{ marginBottom: 16 }}>
                    <button className="ant-btn" disabled={!hasSelected} onClick={this.showModal.bind(this, '放款单填写', true) }>
                        处理
                    </button>
                </div>
                ...
                <AddlWin ref="AddlWin"  
                 ...
                 showModal={this.showModal.bind(this, '放款单填写', true) }
                 housBillBasicInfo={state.housBillBasicInfo} 
                 title={state.title} 
