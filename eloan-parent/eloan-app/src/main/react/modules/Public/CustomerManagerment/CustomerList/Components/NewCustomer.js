...
var statusChildren=[];
        reqwest({
                url: '/getDicts.htm?type=CUSTOMER_STATUS',
                method: 'get', 
                type: 'json',
                success: (result) => {
...
var marryStatusList=[];
        reqwest({
                url: '/getDicts.htm?type=MARRY_STATUS',
                method: 'get', 
                type: 'json',
                success: (result) => {
...
var educationList=[];
        reqwest({
                url: '/getDicts.htm?type=EDUCATION',
                method: 'get', 
                type: 'json',
                success: (result) => {
...
var yearsIncomeList=[]; 
        reqwest({
                url: '/getDicts.htm?type=YEAR_INCOME',
                method: 'get', 
                type: 'json',
                success: (result) => {
