...
export default React.createClass({
  ...
  fetch(params = { pageSize: 5, currentPage: 1 }) {
    ...
    Utils.ajaxData({
      url: '/modules/system/SysConfigAction/getSysConfigList.htm',
      data: params,
      callback: (result) => {
  ...
  delete(record) {
    ...
    confirm({
      ...
      onOk: function () {
        Utils.ajaxData({
          url: "/modules/system/SysConfigAction/deleteSysConfig.htm",
          data: {
            id: record.id,
          },
          method: 'post',
  ...
  render() {
    ...
    return (
      <div className="block-panel">
        ...
        <AddWin ref="AddWin"  visible={state.visible}    title={state.title} hideModal={me.hideModal} record={state.record}
