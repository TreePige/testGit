...
export default React.createClass({
  ...
  fetch(params = {}) {
    ...
    Utils.ajaxData({
      url: '/modules/workflow/ProcessTaskController/queryOritoConfirmationTasks.htm?isCompleted=false',
      data: params,
      callback: (result) => {
  ...
  render() {
    ...
    return (
      <div className="block-panel">
        ...
        <ReviewWin ref="ReviewWin"  visible={state.visible}  id={state.id}  title={state.title} hideModal={me.hideModal} record={state.selectedrecord} canEdit={state.canEdit}/>
      </div>
    );
  }
})
