...
public interface SysMenuDao extends BaseDao<SysMenu,Long>{
	...
	Map getMenuInfoById(Long id) throws PersistentDataException;
	...
	List<Map> getRoleSysMenu(String roleIds, String sysType);
	
	List<Map> getMenuParentId(@Param(value="menuLeafIds") String[] menuLeafIds);
	...
	*/
	 ...
	 * @return
	 */
	List<SysMenu> findValidMenuListByScriptId(Map<String,Object> map);
}
